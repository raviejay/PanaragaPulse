    ...
    <div class="mb-6 sm:mb-8">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex-1 min-w-0">
          <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 break-words">Event Management</h1>
          <p class="text-sm sm:text-base text-gray-600 mt-1">Create and manage eco-events for the community</p>
        </div>
        <button
